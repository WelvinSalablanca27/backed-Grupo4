...
export const actualizarProducto = async (req, res) => {
  try {
    const id_Producto = req.params.id_Producto;
    let { Nombre_Prod, Tipo_Prod, Existencia_Prod, Precio_Costo, Precio_Venta, Fe_caducidad } = req.body;
    ...
    res.json({ mensaje: `Producto con ID ${id_Producto} actualizado correctamente.` });
  } catch (error) {
